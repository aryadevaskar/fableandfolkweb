const workData = [
  {
    ...
    fable:
      "There is no story more important than one built on trust, especially when it comes to children. The fable for this playschool was to create a digital first impression that radiated safety, warmth, and professionalism. The website needed to be more than just informative; it needed to feel like a warm, reassuring hug for anxious parents.",
    ...
    seoTitle: "Case Study: Gayatri Devi International | Fable & Folk",
    seoDescription:
      "Case study of Gayatri Devi International Playschool — a warm, trust-centered digital experience designed for parents and children.",
  },
  {
    id: 2,
    title: "Maya and mi",
    ...
    seoTitle: "Case study:  Maya & Mi | Fable & Folk",
    seoDescription:
      " Website redesign for Maya & Mi, a Shopify store . We crafted a modern, mobile-first site that boosted engagement and conversions.",
  },
  {
    id: 3,
    ...
    gallery: ["/acent/acent1.png", "/acent/acent2.png", "/acent/acent3.png"],
    seoTitle: "Case study:  Ascent Engineering | Fable & Folk",
    seoDescription:
      "Ascent Engineering in Atlanta offers expert civil engineering and site development services with a personal touch—making planning and permitting stress-free.",
  },
  {
    id: 4,
    title: "Krio Energy",
    description:
      "Launching a bold new brand with a story of calm, natural energy.",
    fable:
    ...
    seoTitle: "Case study:  Krio Energy | Fable & Folk",
    seoDescription:
      "Krio Energy is India’s first cacao-based energy drink, designed to deliver natural focus without the sugar crash. See how we built their digital-first brand.",
  },
];
